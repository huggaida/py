...
uDima = go.Scatter(
    x = month,
    y = [24840	,47260	,59390	,41620	,39885	,35550	,39921	,38465	,49560	,29167	,66057	,53354	,24349	,40430	,28218	,26547	,45428	,41380	,46589	,41289	,52398	,45868	,34502	,34572	,33764	,89500	,49186,39188,50671,47916,46493],
    mode = 'lines+markers',
    line=dict(shape='spline'),
    name = 'Dima')
...
uNataly = go.Scatter(
    x = month,
    y = [5000	,13160	,27000	,20645	,12810	,19417	,23624	,9491	,17330	,26670	,37370	,22575	,20075	,21850	,11450	,17200	,28042	,27614	,25365	,12045	,18630	,19147	,19469	,12514	,0	,33516	,26263,11088,13084,20976,23963],
    mode = 'lines+markers',
    line=dict(shape='spline'),
    name = 'Nataly')
...
uVeronika = go.Scatter(
    x = month,
    y = [None,None,None,None,None,None,None,None,None,None,None,None,	11045	,10345	,18345	,19145	,17000	,24300	,31860	,15000	,25200	,26356	,13000	,6620	,14523	,25100	,32090	,25255,27755,
39500,22555,38020],
    mode = 'lines+markers',
    line=dict(shape='spline'),
    name = 'Veronika')
...
uElena = go.Scatter(
    x = month,
    y = [6000	,12600	,16650	,30220	,22876	,0	,28529	,18958	,28888	,17388	,35520	,37650	,39650	,26200	,29000	,21020	,38600	,23600	,27200	,32780	,29530	,24111	,30003	,20670	,30000	,42711	,48320,57320,29500,42800],
    mode = 'lines+markers',
    line=dict(shape='spline'),
    name = 'Elena')
